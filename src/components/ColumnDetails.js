...
export default function ColumnDetails(props) {
    return (
        <sections>
            <div className="container-fluid text-center" style={{ marginTop: "20px", paddingTop: "20px" }}>
                <div className="row align-items-start">
                    <div className="col-4">
                        <div class="fs-2 mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" class="bi bi-lightbulb" viewBox="0 0 16 16" style={{ marginRight: "15px" }}>
                    ...
                    <div className="col-4">
                        <div class="fs-2 mb-3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" style={{marginRight:"15px"}} fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
